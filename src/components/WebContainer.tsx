...
// Define the filesystem structure for a basic Vite/React app
const files = {
  'package.json': {
    file: {
      contents: `{
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-50 z-10">
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm mt-1">Installing dependencies and starting dev server</div>
          </div>
        </div>
      )}
      <iframe
